...
// pointMediaModel представляет DB модель связи точки с её фотографиями
type pointMediaModel struct {
	ID           uuid.UUID  `db:"id"`
...
type pointMediaModels []pointMediaModel

func (mm pointMediaModels) convert() []*entity.PointMedia {
...
func convertPointMedia(e *entity.PointMedia) pointMediaModel {
	m := pointMediaModel{
		ID:           e.ID,
...
func (m pointMediaModel) convert() *entity.PointMedia {
