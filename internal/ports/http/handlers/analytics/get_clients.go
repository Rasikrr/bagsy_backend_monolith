...
// getClients handles GET /api/v1/analytics/clients.
//
...
// @Security     ApiKeyAuth
// @Router       /api/v1/analytics/clients [get]
func (h *Handler) getClients(w http.ResponseWriter, r *http.Request) {
	...
	report, err := h.analyticsUC.GetClients(ctx, orgCtx, params.From, params.To, params.LocationID)
	if err != nil {
		httputil.SendError(ctx, w, err, analyticsErrors)
		return
	}
	...
	setCacheHeaders(w)
	coreHTTP.SendData(ctx, w, toClientsResponse(report), http.StatusOK)
}
