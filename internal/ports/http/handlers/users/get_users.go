...
// @Description - Admin: все пользователи любой сети/точки
...
// @Param roles query []string false "Фильтр по ролям (может быть несколько)" Enums(user,staff,manager,net_manager,self_owner,admin)
// @Param phones query []string false "Фильтр по номерам телефонов (может быть несколько)"
// @Param limit query int false "Количество записей на странице (default: 20, max: 100)"
// @Param offset query int false "Смещение для пагинации (default: 0)"
// @Param sort_by query string false "Поле для сортировки" Enums(phone,name,surname,point_code,network_code,created_at,updated_at) default(created_at)
