...
var authErrors = httputil.ErrorMap{
	...
	authDomain.ErrInvalidToken:         {Code: http.StatusUnauthorized, Message: "unauthorized"},
	authDomain.ErrTokenExpired:         {Code: http.StatusUnauthorized, Message: "token_expired"},
