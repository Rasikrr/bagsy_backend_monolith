// Code generated by "enumer -type=Status -json -trimprefix Status -transform=snake -output media_status_enumer.go"; DO NOT EDIT.
...
const _StatusName = "pendingactiveinactivefailed"

var _StatusIndex = [...]uint8{0, 7, 13, 21, 27}

const _StatusLowerName = "pendingactiveinactivefailed"
...
var _StatusValues = []Status{StatusPending, StatusActive, StatusInactive, StatusFailed}
...
var _StatusNameToValueMap = map[string]Status{
	...
	_StatusName[21:27]:      StatusFailed,
	_StatusLowerName[21:27]: StatusFailed,
}
