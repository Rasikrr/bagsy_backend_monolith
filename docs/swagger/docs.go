...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "internal_ports_http_handlers_employee.featuresResponse": {
            "type": "object",
            "properties": {
                "api_access": {
                    "type": "boolean"
        ...
        "internal_ports_http_handlers_employee.getMeResponse": {
            ...
            "properties": {
                ...
                "organization": {
                    "$ref": "#/definitions/internal_ports_http_handlers_employee.organizationResponse"
                },
                "permissions": {
                    "$ref": "#/definitions/internal_ports_http_handlers_employee.permissionsResponse"
                },
        ...
        "internal_ports_http_handlers_employee.limitValueResponse": {
            "type": "object",
            "properties": {
                "max": {
                    "type": "integer"
        ...
        "internal_ports_http_handlers_employee.limitsResponse": {
            "type": "object",
            "properties": {
                "bookings_monthly": {
                    "$ref": "#/definitions/internal_ports_http_handlers_employee.limitValueResponse"
                },
                "employees": {
                    "$ref": "#/definitions/internal_ports_http_handlers_employee.limitValueResponse"
                },
        ...
        "internal_ports_http_handlers_employee.organizationResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
                ...
                "subscription": {
                    "$ref": "#/definitions/internal_ports_http_handlers_employee.subscriptionResponse"
                }
            }
        },
        ...
        "internal_ports_http_handlers_employee.subscriptionResponse": {
            "type": "object",
            "properties": {
                "current_period_end": {
                    "type": "string"
                ...
                "features": {
                    "$ref": "#/definitions/internal_ports_http_handlers_employee.featuresResponse"
                },
                "limits": {
                    "$ref": "#/definitions/internal_ports_http_handlers_employee.limitsResponse"
                },
                "plan": {
                    "type": "string"
                },
        ...
        "internal_ports_http_handlers_location.locationResponse": {
            ...
            "properties": {
                ...
                "schedule": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_ports_http_handlers_location.scheduleSlotResponse"
                    }
                },
                "schedule_type": {
                    "type": "string"
        ...
        "internal_ports_http_handlers_location.scheduleSlotResponse": {
            "type": "object",
            "properties": {
                "date": {
                    "type": "string"
